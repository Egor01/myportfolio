...
<div class="header-user__block">
    <div class="header-user__profil float-left mr-20">
        ...
        <?php if ($_SESSION['logged_user']['avatarSmall'] != "") { ?>
            <img src="<?=HOST?>usercontent/avatar/<?=$_SESSION['logged_user']['avatarSmall']?>" alt="avatar-small" />            
        <?php } ?>

         </div>
    </div>
    <div class="header-user__profil-block">
        <div class="header-user__name"><?=$_SESSION["logged_user"]["name"]?> <?=$_SESSION["logged_user"]["secondname"]?></div>
        ...
        <div class="header-user__buttons-group">
            ...
            <div class="header-user__buttons-signout"><a class="button button--profile" href="<?php echo HOST . 'logout';?>">Выход</a></div>
        </div>
    </div>
</div>