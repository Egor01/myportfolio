...
$page_title = "Редактировать работу";
...
if ( isset($_POST["upd-work"]) ) {
    ...
    if ( empty($errors) ) {
        ...
        if ( @$_POST['deleteImgWorkEdit'] === "on") {

                $imgPathBig = ROOT . 'usercontent/work/' . $work->img_big;
                $imgPathSmall = ROOT . 'usercontent/work/' . $work->img_small;
        ...
        header( "location: " . HOST . "works/work?id=" . $work->id );
        exit();
    }
